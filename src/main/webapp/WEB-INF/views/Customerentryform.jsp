...
<br><br><br><br>
    ...
    <br>
    <div align="center">
         <form  onsubmit="return validate()" action="insertCustomer" method="post">
            ...
            <tr>
                ...
                <td><input type="date" id="doj" name="doj" pattern="\d{4}-\d{2}-\d{2}" required></td>
                <td></td>
                 <td>BMI</td>
            ...
            <tr>
                <td>Date Of Birth</td>
                <td><input type="date" id="dob" name="dob" pattern="\d{4}-\d{2}-\d{2}" required></td>
                <td></td>
                 <td>Phone Number</td>
            ...
            <tr>
                ...
                <td>Registered By</td>
                <td><input type="text" value= "kiruba" name="registeredby" id="registeredby"  readonly required></td>
